...
public class ThrowTornadoController : MonoBehaviour
{
	//instance of singleton
	private static ThrowTornadoController throwPaperInstance; 
	//ball properties
	...
	public static ThrowTornadoController Instance {
		get {
	...
	private void ResetBall ()
	{
		if (!isStartRoate) {
			...
			ThrowTornadoController.Instance.isCurveReady = false;
		}
	}
